...
<head>
    ...
    <script src="http://localhost/xenoStore/hc/code/highcharts.js"></script>
    <script src="http://localhost/xenoStore/hc/code/highcharts-3d.js"></script>
    <script src="http://localhost/xenoStore/hc/code/modules/exporting.js"></script>
    <script src="http://localhost/xenoStore/hc/code/modules/export-data.js"></script>
    <link rel="stylesheet" href="http://localhost/xenoStore/css/all.css">
    <link rel="stylesheet" href="http://localhost/xenoStore/css/style.css">
    <link rel="stylesheet" href="http://localhost/xenoStore/css/style2.css">
    <link rel="stylesheet" href="http://localhost/xenoStore/css/bootstrap.css">
...
<nav style="font-family: 'Lato';" class="navbar navbar-expand-lg navbar-light bg-dark text-light">
  <a class="navbar-brand text-light" href="<?php RUTA_URL?>inicioC">
    <img src="http://localhost/xenoStore/img/logo.png" width="60" height="40" alt="">
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
        <li class="nav-item active ml-3">
          <a class="btn-login btn-login-header text-light mt-1" href="http://localhost/xenoStore/inicioC">
          <?php
            session_destroy();
          ?>Cerrar sesión
          </a>
        ...
        <li class="nav-item ml-3">
          <a class="nav-link text-light bold" href="<?php RUTA_URL?>bibliotecaC">
        ...
        <li class="nav-item ml-3">
          <a class="nav-link text-light bold" href="#">
